  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <section>
        ...
        >
          <Card className="p-5 bg-gradient-to-br from-neutral-800 to-neutral-900 border-border/50 relative overflow-hidden group">
      ...
      <section className="grid grid-cols-2 gap-3">
        <Card className="p-4 bg-secondary/5 border-none hover:bg-secondary/10 transition-colors cursor-pointer">
